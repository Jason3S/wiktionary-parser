...
/***/ function(module, exports, __webpack_require__) {
	...
	var VisApp = (function (_super) {
	    __extends(VisApp, _super);
	    function VisApp() {
	...
	var TreeNode = (function (_super) {
	    ...
	    TreeNode.prototype.render = function () {
	        var children = this.state.showChildren && this.props.model.c
	            ? this.props.model.c.map(function (node) { return (React.createElement(TreeNode, {"model": node})); })
	            : [];
	        return (React.createElement("div", {"className": "treeNode"}, this.state.showChildren ? '-' : '+', " ", this.props.model.t, children));
	    };
	...
	function render() {
	    ReactDOM.render(React.createElement("div", null, "Hello! ", React.createElement(TreeNode, {"model": tree})), document.getElementsByClassName('visapp')[0]);
	}
	render();
